    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        <Card
          ...
          des="We aim to address global protein deficiency by identifying the challenges faced by disadvantaged populations. Research focuses on the high cost of non-vegetarian proteins and malnutrition in countries like Bangladesh."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          des="We develop an integrated app and web platform to offer affordable vegetarian alternatives. Key features include personalized meal plans, recipe tutorials, and chatbot assistance, ensuring accessibility for all users."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          des="We implement a robust, user-friendly system tailored to user needs. Our platform recommends affordable protein alternatives, provides budget-friendly recipes, and offers personalized support to combat malnutrition effectively."
        >
          <CanvasRevealEffect
            animationSpeed={3}
