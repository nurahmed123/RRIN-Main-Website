...
export function MacbookPreview() {
  return (
    <section className="my-12">
      <div className="overflow-hidden h-[100vh] dark:bg-[#0B0B0F] bg-white w-full">
        <MacbookScroll
          title={
            <span>
              We Are Here To Fight <br /> Against Malnutrition.
            </span>
          }
          badge={
          ...
          src={`https://files.edgestore.dev/iz2sept3369gmc0f/publicFiles/_public/76254b9e-1f71-4a06-88d7-b64b2d1837b7.jpg`}
          showGradient={false}
        />
      </div>
