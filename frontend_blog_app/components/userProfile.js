    ...
    <div>
      <div className="max-w-lg mx-auto my-10 bg-white dark:text-gray-100 shadow-xl dark:bg-slate-800 rounded-lg p-5">
        <img className="w-32 h-32 rounded-full mx-auto" src="https://picsum.photos/200" alt="Profile picture"/>
          ...
          <p className="text-center text-gray-600 mt-1 dark:text-gray-200">Software Engineer</p>
          ...
          <div className="mt-5">
            ...
            <p className="text-gray-600 mt-2 dark:text-gray-200">John is a software engineer with over 10 years of experience in developing web and mobile applications. He is skilled in JavaScript, React, and Node.js.</p>
          </div>
      </div>
    </div>
  )
