                    ...
                    <div className="col-span-4 sm:col-span-9">
                        <div className="bg-white dark:bg-slate-700 shadow rounded-lg p-6">
                            ...
                            <div className="flex justify-center items-center gap-6 my-6">
                                <a className="text-gray-700 dark:text-gray-50 hover:text-orange-600" aria-label="Visit TrendyMinds LinkedIn" href=""
                                    target="_blank">
                                ...
                                <a className="text-gray-700 dark:text-gray-50 hover:text-orange-600" aria-label="Visit TrendyMinds YouTube" href=""
                                    target="_blank">
                                ...
                                <a className="text-gray-700 dark:text-gray-50 hover:text-orange-600" aria-label="Visit TrendyMinds Facebook" href=""
                                    target="_blank">
                                ...
                                <a className="text-gray-700 dark:text-gray-50 hover:text-orange-600" aria-label="Visit TrendyMinds Instagram" href=""
                                    target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-6">
                                        <path fill="currentColor"
                                ...
                                <a className="text-gray-700 dark:text-gray-50 hover:text-orange-600" aria-label="Visit TrendyMinds Twitter" href=""
                                    target="_blank">
