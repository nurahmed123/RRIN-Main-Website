                ...
                <div className=" text-gray-500 dark:bg-[#202937] rounded-3xl shadow-xl w-full overflow-hidden" >
                    <div className="md:flex w-full">
                        ...
                        <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                            ...
                            <form onSubmit={createUserSccount}>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <label htmlFor="" className="text-xs font-semibold px-1 dark:text-gray-300">Name*</label>
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                            <input required value={name} onChange={ev => setName(ev.target.value)} type="text" className="dark:bg-gray-700 dark:text-gray-200 w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Enter your name" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <label htmlFor="" className="text-xs font-semibold px-1 dark:text-gray-300">Username*</label>
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                            <input required value={username} onChange={ev => setusername(ev.target.value)} type="text" className="dark:bg-gray-700 dark:text-gray-200 w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Enter your user name" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <label htmlFor="" className="text-xs font-semibold px-1 dark:text-gray-300">Country*</label>
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                            <input required value={country} onChange={ev => setCountry(ev.target.value)} type="text" className="dark:bg-gray-700 dark:text-gray-200 w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Enter your country name" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <label htmlFor="" className="text-xs font-semibold px-1 dark:text-gray-300">Phone Number*</label>
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                            <input required value={phone} onChange={ev => setPhone(ev.target.value)} type="number" className="dark:bg-gray-700 dark:text-gray-200 w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Enter phone number" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                            <input required value={email} onChange={ev => setEmail(ev.target.value)} type="email" className="dark:bg-gray-700 dark:text-gray-200 w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="email@example.com" />
                                            {email ? <button onClick={SendOTP} className="disabled bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded mx-4">
                                                Send
                                            </button> : <button disabled
                                                className="disabled bg-indigo-500 text-white font-bold py-2 px-4 rounded mx-4">
                                                Send
                                            </button>}
                                        </div>
                                    </div>
                                ...
                                <div className="flex -mx-3 mb-2">
                                    <div className="w-full px-3">
                                        <label htmlFor="" className="text-xs font-semibold px-1 dark:text-gray-300">OTP*</label>
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                            <input required value={otp} onChange={ev => setOTP(ev.target.value)} type="Number" className="dark:bg-gray-700 dark:text-gray-200 w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Enter the otp" />
                                        </div>
                                    </div>
                                </div>
                                {otp === gotp ? "" : <div className="text-left">
                                    <span className="text-sm text-gray-500 dark:text-red-300">Enter correct OTP</span>
                                </div>}
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-1">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input required value={passwordin} onChange={ev => setPasswordin(ev.target.value)} type="password" className="dark:bg-gray-700 dark:text-gray-200 w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-1">
                                        ...
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                            <input required value={repassword} onChange={ev => setRePassword(ev.target.value)} type="password" className="dark:bg-gray-700 dark:text-gray-200 w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                                        </div>
                                    </div>
                                </div>
                                {passwordin === repassword ? "" : <div className="text-left">
                                    <span className="text-sm text-gray-500 dark:text-red-300">Please match the password</span>
                                </div>}
                                <div className="text-center mb-2">
                                    <span className="text-sm text-gray-500 dark:text-gray-300">Alredy have an account? </span>
                                    <Link href="/login" className="text-blue-500 hover:text-blue-600">Login</Link>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        {passwordin === repassword ? <button className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Register</button> : <button disabled className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Register</button>}
                                    </div>
                                </div>
                            </form>
                        </div>
