                        ...
                        <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                            ...
                            <form method="post" action={`${process.env.SITE_URL}/api/auth/callback/credentials`}>
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-1">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input required value={password} onChange={ev => setPassword(ev.target.value)} type="password" className="dark:bg-gray-700 dark:text-gray-200 w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                                        </div>
                                    </div>
                                </div>
                                <div className="text-center mb-2">
                                    ...
                                    <span className="text-sm text-gray-500 dark:text-gray-300 mx-4">OR </span>
                                    <Link href="/passwordreset" className="text-blue-500 hover:text-blue-600">Forget Password</Link>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
