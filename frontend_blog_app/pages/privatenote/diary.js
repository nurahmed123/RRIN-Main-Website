...
export default function userpublishedpost() {
    ...
    return (
        <>
            <Head>
                <title>Published Blogs | RoboSuperior</title>
                                    ...
                                    {currentBlogs.length === 0 ? (
                                        ...
                                        currentBlogs.map((blog, index) => (
                                            <tr key={blog._id} className="border-b dark:bg-[#3a4964] dark:text-gray-100 dark:border-gray-200 shadow-lg">
                                                ...
                                                <td className="px-4 py-2 border-r dark:bg-[#3a4964] dark:text-gray-100 dark:border-gray-200 shadow-lg break-words">{blog.note === "" ? "Spend" : "Note"}</td>
                                                <td className="px-4 py-2 border-r dark:bg-[#3a4964] dark:text-gray-100 dark:border-gray-200 shadow-lg break-words">{blog.debitted ? "Debitted" : "Creditted"}</td>
                                                ...
                                                <td className="px-4 py-2 border-r dark:bg-[#3a4964] dark:text-gray-100 dark:border-gray-200 shadow-lg">{blog.note || 'Null'}</td>
                                                <td className="px-4 py-2 border-r dark:bg-[#3a4964] dark:text-gray-100 dark:border-gray-200 shadow-lg">{blog.cost || 'Null'}</td>
