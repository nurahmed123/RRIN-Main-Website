                        ...
                        {loading ? <><div className="wh-100 flex flex-center mt-2 pb-5">
                            ...
                            {publishedblogs.map((item) => {
                                ...
                                return <div className="cate_blog" key={item._id} data-aos="fade-up">
                                    <Link href={`/achievement/${item.slug}`}><img src={firstImageUrl || "/img/noimage.jpg"} alt="blog" /></Link>
                                    <div className="bloginfo mt-2">
                                        <Link href={`/level/${item.tags[0]}`}><div className="blogtag">{item.tags[0]}</div></Link>
                                        <Link href={`/achievement/${item.slug}`}><h3>{item.title}</h3></Link>
