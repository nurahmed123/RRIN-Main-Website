                    ...
                    <div className="md:flex w-full">
                        ...
                        <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                            <div className="text-center mb-10">
                                <h1 className="font-bold text-3xl text-gray-900 dark:text-gray-100 ">Change Password</h1>
                                <p className=' dark:text-gray-300'>Enter your information to reset pass</p>
                            </div>
                            <form onSubmit={createUserAccount}>
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-1">
                                        <label htmlFor="" className="text-xs font-semibold px-1 dark:text-gray-300">New Password*</label>
                                        <div className="flex">
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        {passwordin === repassword ? <button className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Change Password</button> : <button disabled className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Change Password</button>}
                                    </div>
                                </div>
                            </form>
                        </div>
