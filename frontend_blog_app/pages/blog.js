...
export default function Blog() {
    ...
    const allBlogs = alldata.length; // Total number of blogs
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Stay updated with the latest articles on web development, including Next.js, React, HTML, CSS, JavaScript, and more." />
                ...
                <meta property="og:description" content="Stay updated with the latest articles on web development, including Next.js, React, HTML, CSS, JavaScript, and more." />
                ...
                <meta name="twitter:description" content="Stay updated with the latest articles on web development, including Next.js, React, HTML, CSS, JavaScript, and more." />
                        ...
                        <div className="letstalk_sec mt-3">
                            ...
                            <div className="talk_sec">
                                ...
                                <div className="social_talks flex flex-center gap-1 mt-2">
                                    ...
                                    <div className="st_icon" data-aos="fade-up">
                                        <Link href={"https:linkedin.com/in/06nurahmed"} target="_blank">
                                            <FaLinkedinIn />
                                        </Link>
                                    </div>
                                </div>
